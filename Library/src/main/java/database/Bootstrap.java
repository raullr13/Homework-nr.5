...
public class Bootstrap {
    ...
    private static void dropAll() throws SQLException {
        ...
        {
            System.out.println("Dropping all tables: " + schema);
    ...
    private static void bootstrapTables() throws SQLException {
        ...
        for(String schema : SCHEMAS) {
            ...
            JDBConnectionWrapper jdbcConnectionWrapper = new JDBConnectionWrapper(schema);
        ...
        System.out.println("Done bootstrap tables");
    }

    private static void bootstrapUserData() throws SQLException {
        for(String schema : SCHEMAS)
        {
            System.out.println("Bootstrapping user data for schema: " + schema);
            JDBConnectionWrapper connectionWrapper = new JDBConnectionWrapper(schema);
            rightsRolesRepository = new RightRolesRepositoryMySQL(connectionWrapper.getConnection());
